...
x=['London to Payris', 'Boksi ko ghar', 'Khajure Bro', 'Farki Farki', 'Pujar sarki']
count=0
for i in x:
    count+=1
    print(f"{count}.{ i}")
...
user_name=['Manoj','Laxman','aayush','aditya','awam','sanjeev']
for i in user_name:
    if(i[0]=='A' or i[0]=='a'):
        print(i)
...
user_name=['Manoj','Laxman','aayush','aditya','awan','Sanjeev']
for i in user_name:
    if(i[-1]=='A' or i[-1]=='a'):
        print(i)