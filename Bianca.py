...
#2. Create a list of your five favorite movie. Write a for loop that prints each movie along with its position in the list (e.g., "1. Inception").
movies = ["Deathnote","jab we met","queen of tears", "lova zero to zero","demon"]
count=0
